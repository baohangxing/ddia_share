...
function ReplicationLagSyncing() {
  return (
    <div className="my-6">
      <AlertBanner
...
export default function Section03_Replication() {
  return (
    <section className="min-h-screen relative bg-[#050505] py-16 px-6 md:px-16 overflow-hidden">
      <div
  ...
  orderBy: { createdAt: 'desc' }
        ...
        <PageBlock page="305/1">
          ...
          >
            ...
            <ReplicationLagSyncing />
          </motion.div>
        </PageBlock>

        <PageBlock page="305/2">
          <motion.div
