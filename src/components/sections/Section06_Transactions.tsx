...
export default function Section06_Transactions() {
  return (
    <section className="min-h-screen relative bg-[#050505] py-20 px-4 overflow-hidden">
      <div
...
-- A 的钱不会丢！`}
        ...
        <PageBlock page="606">
          ...
          >
            ...
            >
              崩溃恢复时，数据库读取 WAL 日志：已 COMMIT 的事务重做（Redo）， 未
              COMMIT 的事务回滚（Undo）。保证 A 和 B 的余额永远一致。
            </motion.p>
          </motion.div>
        </PageBlock>
